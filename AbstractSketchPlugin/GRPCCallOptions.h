...
@property(readonly) BOOL retryEnabled; // @synthesize retryEnabled=_retryEnabled;
...
@property(readonly) BOOL flowControlEnabled; // @synthesize flowControlEnabled=_flowControlEnabled;
