...
@class GRPCCallOptions, GRPCRequestHeaders, GRPCWrappedCall, GRXConcurrentWriteable, NSDictionary, NSMutableArray, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSString;
...
+ (void)enableRetry:(BOOL)arg1 forHost:(id)arg2;
...
+ (BOOL)setTLSPEMRootCerts:(id)arg1 forHost:(id)arg2 error:(id *)arg3;
+ (BOOL)setTLSPEMRootCerts:(id)arg1 withPrivateKey:(id)arg2 withCertChain:(id)arg3 forHost:(id)arg4 error:(id *)arg5;
+ (BOOL)isUsingCronet;
...
- (id)initWithHost:(id)arg1 path:(id)arg2 callSafety:(unsigned long long)arg3 requestsWriter:(id)arg4 callOptions:(id)arg5 writeDone:(CDUnknownBlockType)arg6;
